---
title: "Lords Of Waterdeep: Review"
date: 2017-09-20
categories: 
  - "games"
  - "reviews"
...
[CHECK PRICE](http://amzn.to/2xo9MUt)

|   Number of Players   |   Time to Play   |   Ages   |
| --- | --- | --- |
|   2 - 5   |   60 - 120 min   |   12 +   |

Want to quickly learn how to play this game? Check out...[How to Play Lords of Waterdeep - Simplified](http://hexagamers.com/lords-of-waterdeep-how-to-play-simplified)
...
Lords of Waterdeep was one of the earlier [Worker Placement board games](http://hexagamers.com/best-worker-placement-board-games-reviews) that I played. I distinctly remember it being different from lots of the other games that I had played, and that was a good thing. The idea of using your resources ([Meeples](http://hexagamers.com/everything-you-need-to-know-about-board-games#meeples) or cubes in this case), to help you gain more assets (cubes, buildings, quests) was a great new concept. In a sense this is the underlying principle in a lot of games, but placing your Meeples/workers is a great take on it.
...
![](https://res.cloudinary.com/dt4ujaczs/image/upload/Lords-of-Waterdeep-Player-Card-Full_abbcgh.jpg "Lords of Waterdeep - Player Card Full")

​

Thoughts

As mentioned, I hadn’t played too many worker placement games, and this game was my [Gateway board game](http://hexagamers.com/best-gateway-board-games-for-beginners-with-reviews) into the genre; a genre I thoroughly enjoy. For those that don’t know, basically this means that you place your Meeples on spaces on the game board to ‘utilize’ that space, in doing so, you block other players from doing the same.
...
![](https://res.cloudinary.com/dt4ujaczs/image/upload/Lords-of-Waterdeep-Empty-Game-Board_prfblr.jpg "Lords of Waterdeep - Empty Game Board")

In Lords of Waterdeep, you automatically get that worker. However, I have since played a few worker placement games ([Agricola](http://hexagamers.com/agricola-review) ​​​​​and [Stone Age](http://hexagamers.com/stone-age-review) to name a couple) in which you can gain a worker only if you sacrifice the turn of one worker to get an extra in subsequent rounds. Both are interesting concepts, and it is hard to pick which I prefer. I do think that the creators got it right with Lords, it is more of a beginner board game, so adding the complexity (and stress) of trying to time when to add a worker would change the feel of this game.
...
![](https://res.cloudinary.com/dt4ujaczs/image/upload/Lords-of-Waterdeep-Game-Board-Full_nmojcc.jpg "Lords of Waterdeep - Game Board Full")
...
Though, the artwork on the cards, board are fantastic, and the overall theme and story are pretty good. Something you would expect from a game coming from the makers of [Dungeons and Dragons](http://dnd.wizards.com/products/tabletop-games/board-games/lords-waterdeep).
...
![](https://res.cloudinary.com/dt4ujaczs/image/upload/Lords-of-Waterdeep-Intrigue-Cards_qqkmcx.jpg "Lords of Waterdeep - Intrigue Cards")
...
![](https://res.cloudinary.com/dt4ujaczs/image/upload/Lords-of-Waterdeep-Lords-Cards_z6cz36.jpg "Lords of Waterdeep - Lords Cards")
...
![](https://res.cloudinary.com/dt4ujaczs/image/upload/Lords-of-Waterdeep-Gamebox-organization_ytcq7j.jpg "Lords of Waterdeep - Gamebox organization")
